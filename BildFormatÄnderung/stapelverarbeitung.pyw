...
class App:
    def __init__(self, root, design_file):
        ...
        # Laden und Anwenden des Designs
        self.design = self.load_design(design_file)
        self.apply_design(self.design)
    ...
    def save_files(self):
        ...
        messagebox.showinfo('Information','Die Bearbeitung aller Bilder/Videos ist abgeschlossen.')
